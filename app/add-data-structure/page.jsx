      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 md:p-8">
        <div className="w-full max-w-3xl mx-auto">
          ...
          <div className="flex flex-col items-center mb-8">
            <h1 className="text-3xl md:text-4xl font-extrabold text-purple-800 mb-2 text-center drop-shadow-sm">Add New Data Structure</h1>
            <p className="text-purple-600 text-center max-w-xl">Share your knowledge by adding a new data structure. Fill in the details and help others learn!</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-purple-100 overflow-hidden">
            ...
            <div className="h-2 bg-purple-50">
              <div 
                className="h-full bg-gradient-to-r from-purple-500 to-purple-600 transition-all duration-500 rounded-r-full" 
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="flex justify-between mb-8">
                {steps.map((label, i) => (
                  ...
                  >
                    <div 
                      className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 transition-all border-2
                        ${i === step ? 'bg-purple-600 text-white border-purple-600 shadow-md scale-110' : 
                         i < step ? 'bg-green-500 text-white border-green-500 shadow-sm' : 'bg-purple-100 text-purple-600 border-purple-200'}`}
                    >
                      {i < step ? <FiCheckCircle size={20} /> : i + 1}
                    </div>
                    <span className={`text-xs font-semibold ${i <= step ? 'text-purple-800' : 'text-gray-400'}`}>{label}</span>
                    {i < steps.length - 1 && (
                ...
                >
                  ...
                  {step === 0 && (
                    <>
                      ...
                      <div className="relative">
                        <input
                          type="text"
                          className="w-full py-4 px-5 border border-purple-200 rounded-full focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all text-gray-800 shadow-sm placeholder:text-gray-400 placeholder:font-medium text-base"
                          value={title}
                          ...
                          maxLength={50}
                        />
                        <div className="absolute right-5 top-1/2 -translate-y-1/2 text-purple-300 text-sm">
                          {title.length}/50
                        </div>
                      </div>
                  ...
                  {step === 1 && (
                    <>
                      ...
                      <div className="relative">
                        <textarea
                          className="w-full py-4 px-5 border border-purple-200 rounded-2xl focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all min-h-[120px] text-gray-800 shadow-sm placeholder:text-gray-400 placeholder:font-medium text-base"
                          value={description}
                          ...
                          autoFocus
                        />
                        <div className="absolute right-5 bottom-3 text-purple-300 text-sm">
                  ...
                  {step === 2 && (
                    <>
                      ...
                      {paragraphs.map((p, i) => (
                        <div key={i} className="p-5 rounded-xl border-2 border-purple-50 hover:border-purple-200 transition-all group relative bg-purple-50/50 mb-4">
                          {paragraphs.length > 1 && (
                            <button
                              type="button"
                          ...
                          <textarea
                            className="w-full p-3 border border-purple-200 rounded-lg mb-3 focus:ring-2 focus:ring-purple-200 focus:border-purple-500 transition-all min-h-[100px] text-base shadow-sm"
                              ...
                              <div className="space-y-3 pl-6">
                                <div>
                                  ...
                                  <select
                                    ...
                                    className="w-full p-2 border border-purple-200 rounded-lg focus:ring-2 focus:ring-purple-200 focus:border-purple-500 transition-all text-gray-700"
                                  >
                                  ...
                                  (p.linkType === "image" || p.linkType === "video") ? (
                                    ...
                                    <div>
                                      ...
                                      <input
                                        ...
                                        className="w-full p-2 border border-purple-200 rounded-lg focus:ring-2 focus:ring-purple-200 focus:border-purple-500 transition-all"
                                      />
                                    </div>
                                  )
                                )}
                      ...
                      <button
                        ...
                        className="flex items-center justify-center w-full p-3 border-2 border-dashed border-purple-300 rounded-lg text-purple-600 hover:bg-purple-50 transition-all group mt-2"
                      >
                ...
                <div>
                  {step > 0 && (
                    <button
                      type="button"
                      onClick={back}
                      className="px-6 py-3 bg-white text-purple-600 border border-purple-200 rounded-lg hover:bg-purple-50 transition-all flex items-center gap-2 shadow-sm hover:shadow-md font-semibold"
                    >
                      Back
                    </button>
                  )}
                ...
                <div className="flex justify-end">
                  {step < steps.length - 1 ? (
                    <button
                      type="button"
                      onClick={next}
                      className="px-8 py-3 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-lg hover:from-purple-700 hover:to-purple-800 transition-all flex items-center gap-2 shadow-lg hover:shadow-xl font-semibold"
                    >
                      Continue
                    </button>
                  ) : (
                    <button
                      ...
                      className="px-8 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition-all flex items-center gap-2 shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed font-semibold"
                    >
                      {isSubmitting ? (
                        <>
